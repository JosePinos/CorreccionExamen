...
public abstract class Minecraft extends videoJuego{
    private Date fechaLanzamiento;
    private String empresa;
    private String clasificacion;

    public Minecraft(double precio, String genero, String nombre, int anio, int mes, int dia,
